            ...
            if (_dependentes.isEmpty) ...[
              Expanded(
                child: Column(
                  ...
                  children: [
                    Image.asset(
                      'assets/images/add_dependet-Photoroom.png',
                      height: 200,
                      fit: BoxFit.contain,
                    ),
                    const SizedBox(height: 28),
                    const Text(
                      'Ainda não há dependentes',
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    const Padding(
                      ...
                      child: Text(
                        'Adicione um dependente para gerar os códigos de acesso e convidar todas as pessoas envolvidas no cuidado.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 14,
